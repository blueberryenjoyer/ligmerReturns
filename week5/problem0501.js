...
function changeFormat(input) {
    return `${input.name} from District ${input.district}` //this return works
}

function declareTributes(inputTributes) {
    inputTributes.forEach(changeFormat)
    return inputTributes
}

console.log(declareTributes(listOfTributes))