/* 
Phew, you've beaten back the zombies. But it's still the apocalypse, and there's still much more to do. Next up, we need to gather enough food and supplies to make it through
goodness knows how long. It may be time to repurpose our JARVIS bot to gather some food and supplies for our base camp. 
...
That array will contain any number of strings, where each string represents a specific food or type of supply to look for. Your function should use some sort of loop to iterate
 through this array for each individual element. 

Your function should do 2 things:
    1) Your function should log to the console a string that matches the following format: "JARVIS has found some _____!" where the blank space represents the type of
    supply or food to look for. 
...
console.log(gatherSupplies(['thing', 'another thing', 'corn syrup', 'covid-19']))